...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('pcnames.store') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('network_name') is-invalid @enderror" id="network_name" name="network_name" value="{{ old('network_name') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="processor" name="processor" value="{{ old('processor') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="total_HDD" class="col-md-4 col-form-label text-md-end text-start">Total HDD</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="total_HDD" name="total_HDD" value="{{ old('total_HDD') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="operating_system" class="col-md-4 col-form-label text-md-end text-start">Oprerating System</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="operating_system" name="operating_system" value="{{ old('operating_system') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="hark_disk" name="hark_disk" value="{{ old('hark_disk') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="motherboard_summary" class="col-md-4 col-form-label text-md-end text-start">Motherboard Summary</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="motherboard_summary" name="motherboard_summary" value="{{ old('motherboard_summary') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="current_user" name="current_user" value="{{ old('current_user') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="monitors_summary" name="monitors_summary" value="{{ old('monitors_summary') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="screen_size" class="col-md-4 col-form-label text-md-end text-start">Sreen Size</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" id="screen_size" name="screen_size" value="{{ old('screen_size') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="year_used" class="col-md-4 col-form-label text-md-end text-start">Year Used</label>
                        <div class="col-md-6">
                          <input type="date" class="form-control" id="year_used" min="1924-09-08" max="2124-09-08" name="year_used" value="{{ old('year_used') }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Add PC Name">
                    </div>
