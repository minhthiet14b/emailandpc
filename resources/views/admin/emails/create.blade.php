            ...
            <div class="card-body">
                <form action="{{ route('emails.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('pc_name') is-invalid @enderror" id="pc_name" name="pc_name" value="{{ old('pc_name') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('chinese_name') is-invalid @enderror" id="chinese_name" name="chinese_name" value="{{ old('chinese_name') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('skype') is-invalid @enderror" id="skype" name="skype" value="{{ old('skype') }}">
                            @if ($errors->has('skype'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('zalo') is-invalid @enderror" id="zalo" name="zalo" value="{{ old('zalo') }}">
                            @if ($errors->has('zalo'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('webchat') is-invalid @enderror" id="webchat" name="webchat" value="{{ old('webchat') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('line') is-invalid @enderror" id="line" name="line" value="{{ old('line') }}">
                            @if ($errors->has('line'))
